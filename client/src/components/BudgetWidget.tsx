          ...
          {isAdmin && (
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <button
                ...
                title="Recalculate Total Spent from Inventory"
                style={{
                  background: 'none',
              ...
              >
                {isRecalculating ? (
                  <>
                    <span className="spinner-border spinner-border-sm" style={{ width: '0.875rem', height: '0.875rem' }}></span>
                    Recalculating...
                  </>
                ) : (
                  <>
              ...
              <button
                className="btn-edit-budget"
                onClick={() => {
                  setEditAmount(budget.total_budget.toString())
